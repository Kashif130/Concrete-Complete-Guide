...
export async function generateMetadata({
  ...
  return {
    title: `${params.address.slice(0, 6)}…${params.address.slice(-4)} — Concrete Guide Tracker`,
    description:
      "Live Concrete vault positions and points for this wallet — read directly on-chain, no login required.",
  };
}

// Public, shareable, no-form-fill wallet profile page: /tracker/w/0xabc...
...
export default function WalletProfilePage({
  ...
  return <TrackerApp view="profile" initialWallet={params.address} />;
}
